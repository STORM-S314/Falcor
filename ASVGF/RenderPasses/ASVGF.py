...
def render_graph_DefaultRenderGraph():
    ...
    g.create_pass('ASVGFPass', 'ASVGFPass', {'NumIterations': 5, 'HistoryTap': 0, 'FilterKernel': 1, 'TemporalColorAlpha': 0.10000000149011612, 'TemporalMomentsAlpha': 0.10000000149011612, 'DiffAtrousIterations': 5, 'GradientFilterRadius': 2})
    ...
    g.add_edge('GradForwardProjPass.VisibilityBuffer', 'ASVGFPass.GradientVisibilityBuffer')
    ...
    g.add_edge('GradForwardProjPass.GradientSamplesBuffer', 'ASVGFPass.GradientSamples')
