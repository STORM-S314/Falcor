...
def render_graph_DefaultRenderGraph():
    ...
    g.create_pass('ASVGFPass', 'ASVGFPass', {'NumIterations': 5, 'HistoryTap': 0, 'FilterKernel': 1, 'TemporalColorAlpha': 0.05000000074505806, 'TemporalMomentsAlpha': 0.10000000149011612, 'DiffAtrousIterations': 5, 'GradientFilterRadius': 2, 'FramesPerMICalc': 20, 'UseMutualInfCalc': False})
