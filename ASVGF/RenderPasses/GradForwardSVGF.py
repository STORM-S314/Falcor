...
def render_graph_DefaultRenderGraph():
    ...
    g.add_edge('PathTracerMod.color', 'SVGFPass.Color')
    g.add_edge('PathTracerMod.albedo', 'SVGFPass.Albedo')
    g.add_edge('GradForwardProjPass.VisibilityBuffer', 'PathTracerMod.vbuffer')
    ...
    g.add_edge('GBufferRaster.linearZ', 'GradForwardProjPass.LinearZ')
    g.add_edge('GBufferRaster.normW', 'GradForwardProjPass.WorldNormal')
    g.add_edge('GBufferRaster.vbuffer', 'GradForwardProjPass.VisibilityBuffer')
    g.add_edge('GBufferRaster.posW', 'GradForwardProjPass.WPos')
    g.add_edge('GBufferRaster.pnFwidth', 'GradForwardProjPass.PosNormalFWidth')
    g.add_edge('GBufferRaster.viewW', 'GradForwardProjPass.WViewBuffer')
    g.add_edge('GBufferRaster.mvec', 'PathTracerMod.mvec')
    g.add_edge('GradForwardProjPass.RandomNumberBuffer', 'PathTracerMod.randomNumbers')
    g.add_edge('GradForwardProjPass.GradientWViewBuffer', 'PathTracerMod.viewW')
