...
def render_graph_DefaultRenderGraph():
    ...
    g.add_edge('PathTracer.color', 'TAA.colorIn')
...
try:
    ...
    #scene_path = "D:\\data\\EmeraldSquare_v4_1\\EmeraldSquare_Dusk.pyscene" 
    ...
    m.frameCapture.outputDir = "D:\\data\\frames\\GT\\BistroExterior\\32SPP\\60FPS"
    #m.frameCapture.outputDir = "D:\\data\\frames\\GT\\BistroExterior\\32SPP\\144FPS"
    #m.frameCapture.outputDir = "D:\\data\\frames\\GT\\EmeraldSquare_Day\\32SPP\\60FPS"
    #m.frameCapture.outputDir = "D:\\data\\frames\\GT\\EmeraldSquare_Dusk\\32SPP\\144FPS"
    #m.frameCapture.outputDir = "D:\\data\\frames\\GT\\BistroInterior_Wine\\32SPP\\144FPS"
    #m.frameCapture.outputDir = "D:\\data\\frames\\GT\\SunTemple\\32SPP\\144FPS"
    #m.frameCapture.outputDir = "D:\\data\\frames\\GT\\ZeroDay_One\\32SPP\\144FPS"

    start_frame_idx = 407
    frame_size = 1000
    
    for frame_id in range(start_frame_idx,start_frame_idx + frame_size + 1):
        for frame in range(Frames):
            m.clock.frame = frame_id
            m.renderFrame()        
        m.frameCapture.capture()
        print(f"\rGT Captured: {(frame_id - start_frame_idx)} / {frame_size}",end='')
    exit()
